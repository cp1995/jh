...
public class CronUtil {
    ...
    public static Date getNextExecution(String cronExpression) {
        ...
        return cron.next(new Date(System.currentTimeMillis()));
    }
     ...
     * @return Date 下次Cron表达式执行时间
     */
    public static LocalDateTime getNextExecution2(String cronExpression) {
        return StringUtils.isBlank(cronExpression) ? null : getNextExecution(cronExpression).toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime();
    }
